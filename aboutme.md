...
Addressing these items is best accomplished with solid data-driven project artifacts (i.e. the business case, the budget model, the project plan, the communications plan, etc.). The mission, the goal, the assumptions, the timeline and the benefits need to be crystal clear to every stakeholder. 
...
1. Thought everything through and that you have **data** that can soundly answer any questions they have, and;
2. Provided a vision of the future that is compelling based on executing on the initiative.
...
Most recently I have been blending Data Science and domain expertise in Specialty Pharmacy Therapeutics to determine Real World Evidence (RWE) for specific Pharmacologic Therapies and Therapy Management protocols.
